...
class CustomerAdmin(admin.ModelAdmin):
    ...
    list_display = ['company', 'first_name', 'last_name', 'lead_referral_source', 'industry',
                    'address', 'land_phone_number', 'email', 'website', 'status', 'last_contact_date', "_"]
    search_fields = ['company', 'first_name', 'last_name', 'lead_referral_source',
                     'industry', 'land_phone_number', 'email', 'website', 'Situation']
    list_per_page = 25
