...
class AlmazadiProducts(models.Model):
    ...
    add_link = models.URLField(null=True, blank=True, max_length=250, unique=True)
...
class Comment(models.Model):
    ...
    comment_id = models.CharField(null=True, blank=True, max_length=100, unique=True)
    comment_by = models.CharField(null=True, blank=True, max_length=200)
    comment_by_profile = models.CharField(null=True, blank=True, max_length=200)
